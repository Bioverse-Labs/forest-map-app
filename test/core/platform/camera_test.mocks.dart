...
import 'package:forest_map/core/util/image.dart' as _i9;
import 'package:image/image.dart' as _i10;
...
class MockXFile extends _i1.Mock implements _i2.XFile {
  ...
  @override
  _i6.Stream<_i8.Uint8List> openRead([
    int? start,
    int? end,
  ]) =>
      (super.noSuchMethod(
...
///
/// See the documentation for Mockito's code generation for more information.
class MockImageUtils extends _i1.Mock implements _i9.ImageUtils {
  MockImageUtils() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  _i10.Image? fileToImage(_i3.File? file) =>
      (super.noSuchMethod(Invocation.method(
        #fileToImage,
        [file],
      )) as _i10.Image?);
  @override
  _i4.Size getImageSize(_i10.Image? image) => (super.noSuchMethod(
        Invocation.method(
          #getImageSize,
          [image],
        ),
