...
import 'package:forest_map/core/adapters/hive_adapter.dart' as _i6;
import 'package:forest_map/core/util/uuid_generator.dart' as _i7;
...
///
/// See the documentation for Mockito's code generation for more information.
class MockHiveAdapter<T> extends _i1.Mock implements _i6.HiveAdapter<T> {
  MockHiveAdapter() {
    _i1.throwOnMissingStub(this);
  }
...
///
/// See the documentation for Mockito's code generation for more information.
class MockUUIDGenerator extends _i1.Mock implements _i7.UUIDGenerator {
  MockUUIDGenerator() {
    _i1.throwOnMissingStub(this);
  }
